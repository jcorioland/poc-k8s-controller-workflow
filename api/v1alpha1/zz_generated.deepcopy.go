...
func (in *BuildingBlock) DeepCopyInto(out *BuildingBlock) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BuildingBlock.
func (in *BuildingBlock) DeepCopy() *BuildingBlock {
	if in == nil {
		return nil
	}
	out := new(BuildingBlock)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SimulationSpec) DeepCopyInto(out *SimulationSpec) {
	*out = *in
	if in.BuildingBlocks != nil {
		in, out := &in.BuildingBlocks, &out.BuildingBlocks
		*out = make([]BuildingBlock, len(*in))
		copy(*out, *in)
	}
}
...
func (in *SimulationStatus) DeepCopyInto(out *SimulationStatus) {
	*out = *in
	if in.CreatedBlocks != nil {
		in, out := &in.CreatedBlocks, &out.CreatedBlocks
		*out = make([]BuildingBlock, len(*in))
		copy(*out, *in)
	}
}
