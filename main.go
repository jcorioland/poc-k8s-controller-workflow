...
func init() {
	...
	_ = simulationworkflowv1alpha1.AddToScheme(scheme)
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "0d2235ef.poc-simulation-workflow.io",
	})
	if err != nil {
	...
	if err = (&controllers.SimulationReconciler{
		...
		Log:    ctrl.Log.WithName("controllers").WithName("Simulation"),
